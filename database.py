...
def create_tables():
    ...
    commands = (
        ...
        CREATE TABLE IF NOT EXISTS players (
            ...
            hospitalized_until TIMESTAMP DEFAULT NULL, kills INTEGER DEFAULT 0
        );
        """,
